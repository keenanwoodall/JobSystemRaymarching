...
// I stole this bad boy from the HDRP samples and changed it to work without custom input settings
public class FreeCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float inputChangeSpeed = Input.GetKey(KeyCode.LeftShift) ? 1f : -1f;
        if (inputChangeSpeed != 0.0f)
        {
            m_MoveSpeed += inputChangeSpeed * m_MoveSpeedIncrement * Time.deltaTime;
